...
class Evento(db.Model):
    ...
    idSubcategoria = db.Column('id_subcategoria_eve',db.Integer, db.ForeignKey('cad.tb_subcategoria_sub.id_subcategoria_sub'), nullable=False)
    idUsuario = db.Column('id_usuario_eve', db.Integer, db.ForeignKey('cad.tb_usuario_usu.id_usuario_usu'), nullable=False)
